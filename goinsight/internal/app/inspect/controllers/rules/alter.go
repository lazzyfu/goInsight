...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableTiDBMerge(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableDropColsOrIndexes(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableDropTiDBColWithCoveredIndex(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableOptions(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableColCharset(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableAddColOptions(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableAddPrimaryKey(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableAddColRepeatDefine(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableAddIndexPrefix(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableAddIndexCount(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableAddConstraint(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableAddIndexRepeatDefine(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableRedundantIndexes(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableDisabledIndexes(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableModifyColOptions(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableChangeColOptions(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableRenameIndex(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableRenameTblName(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableInnodbLargePrefix(v, r)
// }
...
// 	(*tistmt).Accept(v)
// 	logics.LogicAlterTableRowSizeTooLarge(v, r)
// }
