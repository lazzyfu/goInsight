...
func (e *ExecuteExportToFile) readAndProcessRows(rows *sql.Rows, vals []interface{}, ch chan []interface{}) (int64, error) {
	var rowCount int64
	for rows.Next() {
...
func (e *ExecuteExportToFile) processRowData(vals []interface{}) []interface{} {
...
func (e *ExecuteExportToFile) Run() (data base.ReturnData, err error) {
	var (
		executeLog []string
		startTime  = time.Now()
	)
