...
class DbQueryLog(models.Model):
    ...
    schema = models.CharField(null=False, max_length=256, default='', verbose_name=u'目标数据库')
    tables = models.CharField(null=False, max_length=512, default='', verbose_name=u'目标表名')
