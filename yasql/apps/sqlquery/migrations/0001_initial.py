# Generated by Django 2.2.16 on 2020-12-14 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schema', models.CharField(default='', max_length=256, verbose_name='目标数据库')),
                ('tables', models.CharField(default='', max_length=512, verbose_name='目标表名')),
            ...
            options={
                ...
                'default_permissions': (),
                'index_together': {('schema',), ('tables',), ('username',)},
            },
        ),
        migrations.CreateModel(
