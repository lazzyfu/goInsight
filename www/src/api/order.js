...
export const getOrdersHistoryApi = (params) => get('/api/v1/orders/history', params)
export const getOrderHistoryDetailApi = (params) => get(`/api/v1/orders/history/${params.order_id}`)
