...
from config.config import INCEPTION
...
class InceptionSqlApi(object):
    def __init__(self, host=None, port=None, database=None, contents=None, user=None):
        ...
        self.inception_host = INCEPTION['inception_host']
        self.inception_port = int(INCEPTION['inception_port'])

        obj = MysqlConfig.objects.get(host=self.host, port=self.port)
        self.dst_host = obj.host
        self.dst_user = obj.user
        self.dst_password = obj.password
        self.dst_port = obj.port
