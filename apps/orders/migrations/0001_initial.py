    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rds_type', models.SmallIntegerField(choices=[(0, '非阿里云RDS'), (1, '阿里云RDS')], default=0, verbose_name='数据库的类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.CharField(choices=[('0', '未删除'), ('1', '已删除')], default='0', max_length=2, verbose_name='标记为是否删除')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.CharField(choices=[('0', '待批准'), ('1', '未批准'), ('2', '已批准'), ('3', '处理中'), ('4', '已完成'), ('5', '已关闭'), ('6', '已复核'), ('7', '已勾住')], default='0', max_length=30, verbose_name='进度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('port', models.IntegerField(default=3306, verbose_name='端口')),
                ('sql', models.TextField(default='', verbose_name='SQL')),
                ('sql_type', models.CharField(choices=[('DDL', 'DDL工单'), ('DML', 'DML工单'), ('OPS', '运维工单'), ('EXPORT', '数据导出工单')], default='DML', max_length=10, verbose_name='SQL类型')),
