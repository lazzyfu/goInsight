    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audit_type', models.CharField(choices=[('0', '待批准'), ('1', '未批准'), ('2', '已批准'), ('3', '处理中'), ('4', '已完成'), ('5', '已关闭')], default='0', max_length=10, verbose_name='线上审核类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='主键id')),
                ('operate_type', models.CharField(choices=[('DDL', '数据库定义语言'), ('DML', '数据库操纵语言')], default='', max_length=5, verbose_name='操作类型: DDL or DML')),
