# Generated by Django 2.1.1 on 2018-09-14 05:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('envi_id', models.IntegerField(choices=[('0', 'ceshi'), ('1', 'product')], verbose_name='环境')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='主键id')),
                ('envi_id', models.IntegerField(default=1, verbose_name='当前环境id，从1开始')),
                ('parent_id', models.IntegerField(default=0, verbose_name='父id，指向envi_id')),
                ('envi_name', models.CharField(default='', max_length=30, verbose_name='数据库集群环境')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
            ],
            options={
                'verbose_name': 'sql工单环境定义表',
                'verbose_name_plural': 'sql工单环境定义表',
        ...
        migrations.AlterUniqueTogether(
            name='sqlordersenvironment',
            unique_together={('parent_id',), ('envi_id',)},
        ),
        migrations.AlterUniqueTogether(
            name='mysqlschemas',
