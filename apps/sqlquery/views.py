...
from sqlquery.forms import GetGrantSchemaForm, GetTableStrucForm, ExecSqlQueryForm, GetHistorySqlForm, \
    GetFilterHistorySqlForm, GetTableIndexForm, GetTableBaseForm, DbDictForm
...
class RenderDictView(View):
    def get(self, request):
        """渲染数据字典页面"""
        return render(request, 'sqlquery/mysql_dict.html')
...
class GenerateHtmlView(View):
    ...
    def post(self, request):
        ...
        domain_name_tips = SysConfig.objects.get(key='domain_name_tips').value
