<template>
  <a-modal v-model="visible" title="我的SQL" width="55%" on-ok="onSubmit" @cancel="handleCancel">
...
<script>
import { createFavoritesApi } from '@/api/das'
...
export default {
  data() {
    return {
      visible: false,
      loading: false,
      form: this.$form.createForm(this, { name: 'favoriteAdd' }),
    }
  },
  methods: {
    showModal() {
