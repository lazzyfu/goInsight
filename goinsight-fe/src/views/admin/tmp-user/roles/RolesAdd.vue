<template>
  <a-modal v-model="visible" title="新建角色" width="55%" on-ok="onSubmit" @cancel="handleCancel">
...
<script>
import { createRolesApi } from '@/api/users'
...
export default {
  data() {
    return {
      visible: false,
      loading: false,
      form: this.$form.createForm(this, { name: 'rolesAdd' }),
    }
  },
  methods: {
    showModal() {
