...
INSERT INTO opsql.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority) VALUES (1, '同步远程库表结构元数据', 'query.tasks.periodic_sync_remote_schemameta_to_local', '[]', '{}', null, null, null, null, 1, null, 0, '2019-04-09 04:50:30.330153', '', null, 1, null, 0, null, null);
INSERT INTO opsql.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority) VALUES (2, '同步远程库元数据', 'orders.tasks.periodic_sync_schemas', '[]', '{}', null, null, null, null, 1, null, 0, '2019-04-09 04:51:00.369343', '', null, 1, null, 0, null, null);
